...
def playGame():
	...
	while(1):
		while(1):
			try:
				pointWinner = random.randint(1, 2) #int(input('Point Winner? 1 for '+ players[0] + ' 2 for ' + players[1] + ': '))
...
players.append('Fedex') #str(input('Enter the name of player1: '))
players.append('Djoker') #str(input('Enter the name of player2: '))
